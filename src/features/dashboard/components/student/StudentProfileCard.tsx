        ...
        <div className="space-y-4 flex-1">
          <div className="flex items-start justify-between">
            <div className="space-y-1">
              <h2 className="text-3xl font-extrabold text-gray-900 display-title leading-none">
                {name}
              </h2>
            ...
            <Badge
              variant="outline"
              className="bg-brand-peach text-brand-orange border-brand-orange/20 font-bold px-4 py-1.5 rounded-full text-[10px] uppercase tracking-widest shadow-sm"
            >
              ID: {admissionNo}
            </Badge>
          </div>
