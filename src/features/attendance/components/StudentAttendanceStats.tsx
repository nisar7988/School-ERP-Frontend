...
import { CheckCircle2, XCircle, Clock, Calendar, Percent, ArrowUpRight } from 'lucide-react'
      ...
      <div className="lg:col-span-5 bg-brand-peach/50 border border-brand-orange/10 rounded-[2.5rem] p-8 flex items-center justify-between group hover:shadow-xl hover:-translate-y-1 transition-all duration-500">
        <div className="space-y-6">
          <div className="space-y-2">
            <h3 className="text-3xl font-black text-gray-900 tracking-tight">Stay On Track</h3>
          ...
          <Button 
            className="bg-brand-orange hover:bg-brand-orange-hover text-white rounded-2xl h-12 px-6 font-bold flex items-center gap-2 group-hover:scale-105 transition-all shadow-lg shadow-orange-100"
          >
            View Trends
        ...
        <div className="relative flex items-center justify-center w-40 h-40">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <span className="text-4xl font-black text-gray-900">{stats.percentage}%</span>
            <span className="text-[10px] font-black text-brand-orange uppercase tracking-widest">Attendance</span>
          </div>
        </div>
      </div>
...
function StatCard({ label, value, icon, bgColor, iconBg }: StatCardProps) {
  return (
    <div className={`${bgColor} border border-gray-100 rounded-[2.5rem] p-6 flex flex-col items-start justify-between group hover:shadow-xl hover:-translate-y-1 transition-all duration-500`}>
