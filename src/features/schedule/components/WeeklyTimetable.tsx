      ...
      <div className="min-w-[900px]">
        ...
        <div className="relative">
          ...
          {HOURS.map((hour) => (
            <div
              key={hour}
              className="flex items-start h-[80px] group relative"
            >
          ...
          {DAYS.includes(currentDayName) &&
            currentTotalMins >= START_HOUR * 60 &&
            currentTotalMins <= END_HOUR * 60 && (
              <div
          ...
          <div className="absolute top-0 left-20 right-0 bottom-0 pointer-events-none flex">
            {DAYS.map((day) => {
              ...
              return (
                <div
                  key={day}
                  className="flex-1 relative border-l border-transparent first:border-l-0"
                >
